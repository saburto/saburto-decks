...
test.describe('motion', () => {
  test('an object arrives on its step, and is counted and announced with the rest (R12, R16)', async ({ page }) => {
    ...
    await expect(page.locator('#deck .live')).toHaveText('Slide 11 of 19, step 1 of 3')
  ...
  test('an object moves on its step, and stepping back moves it back (R16)', async ({ page }) => {
    ...
    await page.keyboard.press('ArrowRight')
    await page.keyboard.press('ArrowRight')
    await expect(page.locator('#deck .live')).toHaveText('Slide 11 of 19, step 3 of 3')
    ...
    await expect(page.locator('#deck .live')).toHaveText('Slide 11 of 19, step 2 of 3')
